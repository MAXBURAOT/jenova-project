...
public class QuestEnv {
    ...
    public boolean hasAllCounters() {
        ...
        for (final QuestStepValue questStepValue : this.getCurrentQuestStep().getStepValues()) {
            if (this.getCounters().get(questStepValue.getObjectId()) < questStepValue.getAmount()) {
