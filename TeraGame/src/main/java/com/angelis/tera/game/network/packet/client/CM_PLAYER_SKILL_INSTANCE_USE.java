...
public class CM_PLAYER_SKILL_INSTANCE_USE extends TeraClientPacket {

    private final SkillArgs skillArgs = new SkillArgs();

    public CM_PLAYER_SKILL_INSTANCE_USE(final ByteBuffer byteBuffer, final TeraGameConnection connection) {
