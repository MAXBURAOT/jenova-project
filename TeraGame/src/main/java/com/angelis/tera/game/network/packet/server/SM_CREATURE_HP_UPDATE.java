...
public class SM_CREATURE_HP_UPDATE extends TeraServerPacket {
    ...
    public SM_CREATURE_HP_UPDATE(final Creature creature, final Creature attacker, final int diff) {
    ...
    protected void writeImpl(final TeraGameConnection connection, final ByteBuffer byteBuffer) {
        writeD(byteBuffer, creature.getCreatureCurrentStats().getHp());
        writeD(byteBuffer, creature.getCreatureBaseStats().getBaseHp());
