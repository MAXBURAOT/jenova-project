...
public class LogFile
{
    ...
    public void loadHeaders()
    {
        ...
        {
            MainPacket.getUserInterface().log("We cant read headers from a file that doesnt support header reading");
        }
        try
        {
            _reader.parseHeader();
    ...
    {
        if(!this.isRemote())
            MainPacket.getUserInterface().log("We are setting a remote property on a non-remote file. Things are going  wrong...");
        _remoteBitset = bits;
    }
