...
public class Util {
    ...
    public static String makeFormatPartString(List<Part> parts) {
        TextBuilder tb = new TextBuilder();
        for (Part part : parts) {
            if (part instanceof ForPart) {
                tb.append("[");
                tb.append(makeFormatPartString(((ForPart) part).getModelBlock().getParts()));
                tb.append("]");
            }
                ...
                while (i.hasNext()) {
                    ...
                    tb.append(makeFormatPartString(entry.getParts()));
                    if (i.hasNext())
                        tb.append("|");
                }
                tb.append("]");
    ...
    public static CharSequence makeFormatTypeString(List<PartType> idParts) {
        TextBuilder tb = new TextBuilder();
