...
import com.angelis.tera.packet.logrepo.RemoteLogRepositoryBackend;
...
public class MainRepoTab extends JPanel implements ActionListener
{
    ...
    {
        String repoUser = MainPacket.getConfigProperty("RepositoryUser");
        String repoPass = MainPacket.getConfigProperty("RepositoryPass");
    ...
    {
        String repoProxyHost = MainPacket.getConfigProperty("RepositoryProxyHost", "");
        String repoProxyPort = MainPacket.getConfigProperty("RepositoryProxyPort", "");
        String repoProxyActive = MainPacket.getConfigProperty("RepositoryProxyActive", "False");
    ...
    public void enableProxy()
    {
        try
        {
            ...
            MainPacket.setConfigProperty("RepositoryProxyHost", host);
            MainPacket.setConfigProperty("RepositoryProxyPort", port);
            MainPacket.setConfigProperty("RepositoryProxyActive", "True");
        }
    ...
    private void disableProxy()
    {
        ...
        MainPacket.setConfigProperty("RepositoryProxyActive", "False");
    }
        ...
        if (cmd.equals("enable"))
        {
            if (!enableSavedAccount())
            {
                ...
                if (_saveCheck.isSelected())
                {
                    ...
                    MainPacket.setConfigProperty("RepositoryUser", MainRepoTab.this.getUserName());
                    MainPacket.setConfigProperty("RepositoryPass", RemoteLogRepositoryBackend.getInstance().getPassword());
                }
                else
                {
                    MainPacket.setConfigProperty("RepositoryUser", "");
                    MainPacket.setConfigProperty("RepositoryPass", "");
                }
            }
        }
