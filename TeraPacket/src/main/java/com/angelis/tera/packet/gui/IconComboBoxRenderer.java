...
public class IconComboBoxRenderer extends JLabel implements ListCellRenderer {
    ...
    private static final ImageIcon[] images = { IconsTable.ICON_C, IconsTable.ICON_H, IconsTable.ICON_D, IconsTable.ICON_F, IconsTable.ICON_Q, IconsTable.ICON_S, IconsTable.ICON_S_SMALL, IconsTable.ICON_B, IconsTable.ICON_X, IconsTable.ICON_FOR, IconsTable.ICON_SWITCH, };
