...
public class SearchDlg extends JDialog {
    ...
    public int search(int startIndex) {
        GameSessionViewer gameSessionViewer = ((Main) MainPacket.getUserInterface()).getViewerTab().getCurrentViewPane().getGameSessionViewer();
    ...
    private void getAllFormatsName() {
        ...
        GameSessionViewer viewer = ((Main) MainPacket.getUserInterface()).getViewerTab().getCurrentViewPane().getGameSessionViewer();
        if (viewer == null)
            return;
