...
public class ProtocolTab extends JPanel {
    ...
    public ProtocolTab() {
        ...
        _partTypeCombo = new JComboBox<String>(IconComboBoxRenderer.types);
    ...
    private static void resizeTreeColumn(JXTreeTable treeTable) {
         ...
         * treeTable.getTableHeader().getDefaultRenderer(); TableColumn column =
         ...
         * 
         * int cellWidth = treeTable.getMaximumSize().width; cellWidth += 40;
         * //offset for the comboBox
         * 
         * int newWith = Math.max(headerWidth, cellWidth);
         * column.setPreferredWidth(newWith); column.setMinWidth(newWith);
    ...
    private class PacketEditorActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getActionCommand().equals("+")) {
                ...
                final JDialog createDialog = new JDialog(((Main) MainPacket.getUserInterface()).getProtocolEditor(), "Create new Packet");
                ...
                createButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if ("create".equals(e.getActionCommand())) {
                            ...
                            JDialog idDialog = new JDialog(((Main) MainPacket.getUserInterface()).getProtocolEditor(), "Create new Packet");
                ...
                createDialog.setLocationRelativeTo(((Main) MainPacket.getUserInterface()).getProtocolEditor());
    ...
    private class PacketPartMouseMotionListener implements MouseInputListener {
        ...
        public void mousePressed(MouseEvent e) {
            if (_format == null)
                return;
            if (_dragedObject != null && (e.getModifiersEx() & InputEvent.BUTTON3_DOWN_MASK) == InputEvent.BUTTON3_DOWN_MASK) {
                // TODO: cancel
